...
public class Main {
	...
	CampoCNPJ cpnj = new CampoCNPJ(234);
	dialogo.add(cpnj, cons);
	
	CampoTEL tel = new CampoTEL(234);
	dialogo.add(tel, cons);
	
	CampoCEP cep = new CampoCEP("34534");
	dialogo.add(cep, cons);
	
	CampoEmail email = new CampoEmail(200);
	dialogo.add(email, cons);
